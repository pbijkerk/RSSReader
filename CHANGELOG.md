...
- `CLAUDE.md` waarschuwt nu bij de toolchain dat device-builds niet met `-derivedDataPath` binnen de projectmap mogen draaien, en `Workflow-feature.md` benoemt het waargenomen attribuut (`com.apple.provenance`) plus dat `xattr -rc` het probleem niet oplost
